...
import time
from pyrts.core.cache.backends.redis.client import Redis
from pyrts.core.cache.backends.redis.connection import ConnectionPool
from pyrts.core.restexception import NotList
from pyrts.core.cache.backends.redis.cluster import ClusterRedis
try:
    import cPickle as pickle
except ImportError:
    import pickle

from pyrts.core.cache.base import *
from pyrts.core.sync import *
from pyrts.corecache.backends.redis import ResponseError
from pyrts.corecache.backends.redis.connection import UnixDomainSocketConnection, Connection, DefaultParser
from pyrts.coreencodings import *
...
class CacheConnectionPool(object):
    ...
    def get_connection_pool(self, host='127.0.0.1', port=6379, db=1,
        ...
        if not self._connection_pools.get(connection_identifier):
            ...
            self._connection_pools[connection_identifier] = ConnectionPool(**kwargs)
